...
internal static class NonAscii
{
    ...
    {
        if (International.TryGetValue(c, out var value))
        {
	        return value;
        }
        else if (Latin.TryGetValue(c, out var value1))
        {
	        return value1;
        }
        else if (Turkish.TryGetValue(c, out var value2))
        {
	        return value2;
        }
        else if (Greek.TryGetValue(c, out var value3))
        {
	        return value3;
        }
        else if (Czech.TryGetValue(c, out var value4))
        {
	        return value4;
        }
        else if (Arabic.TryGetValue(c, out var value5))
        {
	        return value5;
        }
        else if (Vietnamese.TryGetValue(c, out var value6))
        {
	        return value6;
        }
        else if (Polish.TryGetValue(c, out var value7))
        {
	        return value7;
        }
        else if (Latvian.TryGetValue(c, out var value8))
        {
	        return value8;
        }
        else if (German.TryGetValue(c, out var value9))
        {
	        return value9;
        }
        else if (Ukrainian.TryGetValue(c, out var value10))
        {
	        return value10;
        }
        else if (Serbian.TryGetValue(c, out var value11))
        {
	        return value11;
        }
        else if (Russian.TryGetValue(c, out var value12))
        {
	        return value12;
        }
