	...
	public class HashParserTests
	{
		...
		*/
		...
		public void SHA256_Test()
		{
			...
			Assert.IsTrue(isParsed);
			Assert.AreEqual(HashAlgorithms.SHA2_256, algorithm);
		...
		public void SHA2_512_224_Test()
		{
			...
			Assert.IsTrue(isParsed);
			Assert.AreEqual(HashAlgorithms.SHA2_512_224, algorithm);
			Assert.AreEqual(224, outputBitSize);
		...
		public void SHA3_224_Test()
		{
			...
			Assert.IsTrue(isParsed);
			Assert.AreEqual(HashAlgorithms.SHA3_224, algorithm);
			Assert.AreEqual(224, outputBitSize);
		}
		...
		public void SHA3_384_Test()
		{
			...
			Assert.IsTrue(isParsed);
			Assert.AreEqual(HashAlgorithms.SHA3_384, algorithm);
			Assert.AreEqual(384, outputBitSize);
		}
